...
public class MonitorServlet extends HttpServlet {
    ...
    private static final Logger log = Logger.getLogger(MonitorServlet.class);
    ...
    protected void doPost(HttpServletRequest request,
        ...
        // the status
        {
            ...
            if (status.equals(STOPPED) && null != client
                ...
                log.info("Status changed from " + STOPPED + " to " + status
     ...
     * setter method
     *
     * @param waitTimeForFullGC the waitTimeForFullGC to set
     * @see MonitorServlet#waitTimeForFullGC
     */
